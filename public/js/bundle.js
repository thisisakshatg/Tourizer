...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib2xpdmVyLXF1ZWVuIiwiYSI6ImNreWN0Y2JlbDBzbjgydm4wOHY0ZXVidzIifQ.BTfUei4n38aK9SSxMZNBBA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends mapbounds to include current location
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'Logging out failed! Try again!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successully!"));
              window.setTimeout(function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51KJeauSFiZ0hADkNacXyIvFm6e3dhpDHUiGHB9jIbr0exAeTZH1OiYb23EnvImmOWMQz9TTim4zDwji0paACoY7z003yarNxI7'); // 1) Get session from API
          ...
          case 10:
            _context.prev = 10;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Checkout failed!');
